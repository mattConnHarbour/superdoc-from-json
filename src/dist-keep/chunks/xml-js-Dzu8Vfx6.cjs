...
function requireDist() {
  ...
  (function(exports2) {
    ...
    exports2.Blob = buffer.Blob;
    exports2.BlobOptions = buffer.BlobOptions;
    exports2.Buffer = buffer.Buffer;
    exports2.File = buffer.File;
    exports2.FileOptions = buffer.FileOptions;
    exports2.INSPECT_MAX_BYTES = buffer.INSPECT_MAX_BYTES;
    exports2.SlowBuffer = buffer.SlowBuffer;
    exports2.TranscodeEncoding = buffer.TranscodeEncoding;
    exports2.atob = buffer.atob;
    exports2.btoa = buffer.btoa;
    exports2.constants = buffer.constants;
    exports2.default = Buffer;
    exports2.isAscii = buffer.isAscii;
    exports2.isUtf8 = buffer.isUtf8;
    exports2.kMaxLength = buffer.kMaxLength;
    exports2.kStringMaxLength = buffer.kStringMaxLength;
    exports2.resolveObjectURL = buffer.resolveObjectURL;
    exports2.transcode = buffer.transcode;
  })(dist);
  return dist;
}
var util = {};
...
function requireUtil() {
  ...
  (function(exports2) {
    ...
    exports2.deprecate = function(fn, msg) {
      if (typeof vue.process$1 !== "undefined" && vue.process$1.noDeprecation === true) {
        return fn;
      }
      if (typeof vue.process$1 === "undefined") {
        return function() {
      ...
      function deprecated() {
        if (!warned) {
          if (vue.process$1.throwDeprecation) {
            throw new Error(msg);
          } else if (vue.process$1.traceDeprecation) {
            console.trace(msg);
          } else {
            console.error(msg);
          }
    ...
    var debugs = {};
    var debugEnvRegex = /^$/;
    if (vue.process$1.env.NODE_DEBUG) {
      var debugEnv = vue.process$1.env.NODE_DEBUG;
    ...
    function callbackify(original) {
      ...
      function callbackified() {
        ...
        original.apply(this, args).then(
          function(ret) {
            vue.process$1.nextTick(cb.bind(null, null, ret));
          },
          function(rej) {
            vue.process$1.nextTick(callbackifyOnRejected.bind(null, rej, cb));
          }
        );
      }
...
function requireBrowser() {
  ...
  function config(name) {
    try {
      if (!jszip.commonjsGlobal.localStorage) return false;
    } catch (_) {
      return false;
    }
    var val = jszip.commonjsGlobal.localStorage[name];
...
exports.requireEndOfStream = requireEndOfStream;
exports.requireGetIntrinsic = requireGetIntrinsic;
exports.requireInherits_browser = requireInherits_browser;
exports.requirePipeline = requirePipeline;
exports.requireType = requireType;
exports.require_stream_duplex = require_stream_duplex;
